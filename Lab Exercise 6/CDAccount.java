...
public class CDAccount extends Account 
{
	   ...
	   {
		   return String.format("\n%-20s%-20s%-20s%-20s%-20s%-20s\n", "Account Number",  "Initial Balance","Duration","Mothly Balance", "Rate(%)", "Date Created")
	       +("========================================================================================================================================\n")
	       +String.format("%-20d%-20.2f%-20d%-20.2f%-20.2f%20s\n", getId(), getBalance(),getDuration(), getMatureBalance(), getCDAnnualInterestRate(), getDateCreated());   
	   }
